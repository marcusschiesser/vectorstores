...
```package-install
npm install @vectorstores/discord
```
...
<include cwd>../../examples/ingestion/readers/discord/reader.ts</include>
...
- [DiscordReader](/framework-api-reference/classes/discordreader/)
