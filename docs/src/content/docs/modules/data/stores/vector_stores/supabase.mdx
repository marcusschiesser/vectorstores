...
```package-install
npm i llamaindex @vectorstores/supabase
```
...
```ts
import { FilterOperator, MetadataFilters } from "@vectorstores/core";
...
- [SupabaseVectorStore](/framework-api-reference/classes/supabasevectorstore/)
