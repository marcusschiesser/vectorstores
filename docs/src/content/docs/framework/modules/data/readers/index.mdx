...
- [TextFileReader](/framework-api-reference/classes/textfilereader/): `.txt`
- [PDFReader](/framework-api-reference/classes/pdfreader/): `.pdf`
- [CSVReader](/framework-api-reference/classes/csvreader/): `.csv`
- [MarkdownReader](/framework-api-reference/classes/markdownreader/): `.md`
- [DocxReader](/framework-api-reference/classes/docxreader/): `.docx`
- [HTMLReader](/framework-api-reference/classes/htmlreader/): `.htm`, `.html`
- [ImageReader](/framework-api-reference/classes/imagereader/): `.jpg`, `.jpeg`, `.png`, `.gif`
...
- [SimpleDirectoryReader](/framework-api-reference/classes/simpledirectoryreader/)
